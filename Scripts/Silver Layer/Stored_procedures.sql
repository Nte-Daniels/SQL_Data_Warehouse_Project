/********************************************************************************************
 SCRIPT NAME : SILVER LAYER TRANSFORMATION & LOAD
 DESCRIPTION :
     TRANSFORMS RAW BRONZE DATA INTO CLEAN, STANDARDIZED
     SILVER LAYER TABLES FOR ANALYTICS AND REPORTING.
********************************************************************************************/
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CASE 
                WHEN TRY_CAST(sls_sales AS INT) IS NULL
                  ...
                  OR TRY_CAST(sls_sales AS INT)
                     != TRY_CAST(sls_quantity AS INT) * ABS(TRY_CAST(sls_price AS INT))
            ...
            CASE    
                ...
                THEN TRY_CAST(sls_sales AS INT)
        ...
        ------------------------------------------------------------
        PRINT 'Processing ERP PRODUCT CATEGORY';
        PRINT '----------------------------------------------------------------------';
